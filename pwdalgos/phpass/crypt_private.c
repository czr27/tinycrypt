...
/**
   crypt_private password $P$BsISJ1ALn

   <signature> <count> <salt>
   
   Salt should be 8 bytes, count is one character from itoa64 string
   
   The character after $P$ is index of itoa64
*/
