...
static  int hydro_x25519_scalarmult_base(uint8_t       pk[hydro_x25519_PUBLICKEYBYTES],
...
hydro_x25519_scalarmult(uint8_t out[hydro_x25519_BYTES], const uint8_t scalar[hydro_x25519_BYTES],
                        const uint8_t x1[hydro_x25519_BYTES], int clamp)
{
                        ...
                        const hydro_x25519_scalar_t b)
{
    ...
    hydro_x25519_limb_t carry, carry2;
    hydro_x25519_limb_t acc;
    hydro_x25519_limb_t mand, mand2;
    hydro_x25519_limb_t need_add;
    int                 i, j;

    for (i = 0; i < hydro_x25519_NLIMBS; i++) {
        carry = 0, carry2 = 0, mand = a[i],
