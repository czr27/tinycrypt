...
/* ===================================================================== */
/*
 * MODIFICATION FOR SATURNIN-SHORT.
 *
 * Saturnin-Short is a specialized AEAD mode that does not support
 * additional authenticated data, and accepts plaintexts only up to
 * 15 bytes. The maximum message length and maximum associated data
 * length below are adjusted to match these characteristics.
 */
