/* Reference implementation of SPIX Permutation
 Written by:
...
;;Store t and t' at data memory at location 522 & 523
ldi R20,0x0f  ;;0-5
STS $521, R20
ldi R20,0x47
STS $522, R20
...
;; (t, t') is from 521 - 544 in hex

;; (SC, SC') is from 621 - 644 in hex
...
LCircularShift:
	...
	LDI R30, 0
	MOV R15, R30 ; set the "i" in while
	WHIL:	CP R15, R29 ; Compare n(START at 0) with limit
			BRSH NEXTA
