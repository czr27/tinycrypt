/* Reference implementation of SPIX_8(l_ad=0, l_m=16)
 Written by:
...
LDI R22, 0X00 ; for test purpose only, do not run this line, remove it in real implementation!!!!
...
;;this is Simeck box
FFUN: ;need pass rc0 (R14) into it. This is the function h
PUSH R12
PUSH R13
PUSH R27
...
LDI R27, 0  
MOV R12, R27
WHIL2:	CP R12, R13 ; Compare n(START at 0) with limit(=5)
		BRSH NEXTB2
		call SimeckRF
		inc R12
		rjmp WHIL2 ; Go back to beginning of WHILE loop
NEXTB2:
