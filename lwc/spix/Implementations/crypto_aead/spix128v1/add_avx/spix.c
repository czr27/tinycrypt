...
/*
   *sliscp_light256: 18-round sliscp-light permutation
...
/*
   *sliscp256: 18-round sliscp-light permutation of width 256 bits
...
/*
   *sliscp256: 9-round sliscp-light permutation of width 256 bits
   *x: input state, and output state is stored in state (inplace)
*/
...
void crypto_aead_encrypt( u32 *tag, u32 tlen, u32 *ciphertext, u32 *plaintext, u32 plen, u32 *ad, u32 adlen, u8 *nonce, u8 *key)
{
	...
	sliscp256(x); //18-round sliscp-light permutation
...
/*
   ...
   *key: key 
   *nonce: public nonce
   *adlen: length of ad (in 32-bit word)
   *ad: associate data
   *tlen: length of tag (in 32-bit word)
   *tag: tag
   *plen: length of plaintext (in 32-bit word)
   *plaintext: plaintext to be encrypted
   *ciphertext: ciphertext
*/
