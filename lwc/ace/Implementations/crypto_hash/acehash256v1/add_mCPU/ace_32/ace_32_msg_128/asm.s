/* Reference implementation of ACE32 HASH128 (2,4)
 Written by:
...
;;store Ms:--------         location: 20000600
        ...
        LDR R10, =0x335588dd    ;M0
        STR R10, [R11, #0]
        LDR R10, =0x00111122
        STR R10, [R11, #4]
        
        LDR R10, =0x335588dd    ;M1
        STR R10, [R11, #8]
        LDR R10, =0x00111180
        STR R10, [R11, #12] 
...
FFUNSQUZ
        ...
        STR R3, [R11, #36]      ;;A[7]-A[4] which is hashed value, save to somewhere 
        STR R2, [R11, #20]         ;;C[7]-C[4]   which is hashed value, save to somewhere      
        STR R1, [R11, #0]         ;;E[0]  which is hashed value, save to somewhere 
   ;;OUTPUT 1 here
        BL FFUN3
