; Se puede aumentar la velocidad más todavía, expandiendo la rutina ap_getgamma
; de forma que pongamos inline los primeros pasos de la rutina, al precio de 15 bytes
; por cada bit optimizado (hasta el octavo, luego 17 hasta el 15 que sería el último).
; Aquí pongo un ejemplo con 2 bits optimizados (227 bytes):
